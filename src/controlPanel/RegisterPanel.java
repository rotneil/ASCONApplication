...
public final class RegisterPanel extends javax.swing.JPanel implements Constants {
     ...
     * @param ascon
     */
    public RegisterPanel(ASCONApplication ascon) {
        // set the instance variables
        this.asconApp = ascon;
        this.mSchema = ascon.getSchema();
        
        // date variables
        dayOfMonth = ascon.getDaysOfMonth();
        monthOfYear = ascon.getMonthOfYear();
        year = ascon.getYear();
    ...
    private void initComponents() {
        ...
        savePrintButton.setText("Save & Print");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(13, 13, 13)
                .addComponent(cancelButton, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)
                .addGap(0, 0, 0)
                .addComponent(saveButton, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(savePrintButton, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    /*
    ** Method to save an instance of a new client
    */
    private void processNewClient (boolean print)
    {
        try {
            // obtain user's entry
            ...
            if(refStr.equals(""))
                throw new IllegalArgumentException("Reference Number Field cannot"
                        + " empty");
            
            // save to database
            mSchema.createNewClient(name, company, address, 
                    ...
                    department, cost, refStr);
            
            // show success message if FLAG print is false
            // Save without print option
            if (!print) {
                SuccessMessageDialog.show(asconApp, 
                        "Client Successfully Saved to Database");
            // Save with print option
            } else {
                // get the id of the newly registered client
                long clientId = mSchema.getNewlyRegisteredClientId ();
                asconApp.showClientView(clientId);
            }

            // clear the fields for new fresh entries
            clearFields ();
    ...
    */
    private void clearFields ()
    {
        ...
        notAvailableButton.setSelected(false);

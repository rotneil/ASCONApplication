...
implements Constants 
{
    ...
    private ParameterEditDialog.ParameterEditListener mListener;
    private int settingType;
    
    /**
     * Creates new form NewParameterDialog
     */
    public NewParameterDialog(ApplicationHomePage parent,
            ParameterEditDialog.ParameterEditListener listener, int type) {
        super(parent, true);
    ...
    {
        try {
            String variable = nameField.getText();
            if (variable.equals(""))
                throw new Exception ("Parameter Name cannot be empty");
            
            // save a new instance
            boolean status = parent.getSchema().createNewSettingName(
                    settingType, variable);
            if (status) {
                SuccessMessageDialog.show(parent, "New Parameter successfully" +
                        " saved");
                mListener.onDispose();
            }
        } catch (Exception e) {
